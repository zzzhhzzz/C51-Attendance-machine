...
uchar FIFO[MAX_NUMBER+1]={0};//数据暂存数组
...
/*********************************************************
函数void UART_send_char(uchar dat)
串口发送一个字节数据
*********************************************************/
...
/*********************************************************
函数bit Command(uchar *p,uchar MaxTime)
命令解析,给模块发送一个命令
*p指令，MaxTime延时时长
*********************************************************/
...
/*********************************************************
函数uchar ImgProcess(uchar BUFID)
发获取图像并生成特征文件，存入BUFID中 
BUFID为缓冲区号
*********************************************************/
